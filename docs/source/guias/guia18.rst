...
3. Cree ``CohereAssistant`` para que se encargue de interactuar con la API de Cohere del envío de consultas con los parámetros del clima y el manejo de la respuesta, considerando los siguientes aspectos: 
